...
/*
 ...
 +			       display of the programming code and its indentation.
 + ---
 +
 +
 +
...
$_GLOBAL_SYSTEM_INSTALLATION_FILE						= "Install.php";
...
$_GLOBAL_SYSTEM_SECURITY_MASTER_SANITIZATION_FILE				= "./System/Security/Modules/Master_Sanitization";
...
/*
 ================================================================
 + Check For Authentic Credentials In Browser Cookies
 ================================================================
*/
...
/*
 ================================================================
 + Update Rank Based On Experience Amount
 ================================================================
*/
...
$_DB_Query_Main_Member_Update_Rank 						= $DB->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_rank_level='$_MAIN_MEMBER_RANK_UPDATE_DIGIT' WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME'");
...
$_DB_Query_Main_Update_Member_Rank_SELECT_FROM_RANKS				= $DB->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_ranks ORDER BY id ASC");
$_DB_Query_Main_Update_Member_Rank_SELECT_FROM_RANKS_FETCH_ARRAY		= $DB->fetch_array($_DB_Query_Main_Update_Member_Rank_SELECT_FROM_RANKS);
...
$_GLOBAL_MEMBER_RANK_1								= $_DB_Query_Main_Member_Rank_Fetch_Array['rank_1'];
$_GLOBAL_MEMBER_RANK_2								= $_DB_Query_Main_Member_Rank_Fetch_Array['rank_2'];
$_GLOBAL_MEMBER_RANK_3								= $_DB_Query_Main_Member_Rank_Fetch_Array['rank_3'];
$_GLOBAL_MEMBER_RANK_4								= $_DB_Query_Main_Member_Rank_Fetch_Array['rank_4'];
$_GLOBAL_MEMBER_RANK_5								= $_DB_Query_Main_Member_Rank_Fetch_Array['rank_5'];
...
if ($_GLOBAL_MEMBER_RANK == 1) {
	...
	$_GLOBAL_MEMBER_RANK_DISPLAY = $_GLOBAL_MEMBER_RANK_1;

} // [ + ] IF: Member Rank Is 1

if ($_GLOBAL_MEMBER_RANK == 2) {

	$_GLOBAL_MEMBER_RANK_DISPLAY = $_GLOBAL_MEMBER_RANK_2;

} // [ + ] IF: Member Rank Is 2

if ($_GLOBAL_MEMBER_RANK == 3) {

	$_GLOBAL_MEMBER_RANK_DISPLAY = $_GLOBAL_MEMBER_RANK_3;

} // [ + ] IF: Member Rank Is 3

if ($_GLOBAL_MEMBER_RANK == 4) {

	$_GLOBAL_MEMBER_RANK_DISPLAY = $_GLOBAL_MEMBER_RANK_4;

} // [ + ] IF: Member Rank Is 4

if ($_GLOBAL_MEMBER_RANK == 5) {

	$_GLOBAL_MEMBER_RANK_DISPLAY = $_GLOBAL_MEMBER_RANK_5;
