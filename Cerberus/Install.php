...
/*
 ...
 +
 + ---
 + - File Location: root->Cerberus->Install.php
...
/*
 ...
 +
 +
 + [ @ ] Cerberus Content Management System :: Installation Application
 +
 +
 +
 ================================================================
...
echo ("
		<HR><CENTER><BIG><B>[ <A HREF=\"https://www.SourceForge.net/projects/cerberuscms/files/Documentation/\" TARGET=\"_NEW\" TITLE=\":: Read The Cerberus Content Management System Installation Documentation ::\">Installation Documentation</A> ]</B></BIG></CENTER><HR>
		<BR>
		...
		* <I>S.Q.L. Database Server Name Table' Prefix</I>:<BR>
		[ Example: 'MySQLDatabaseTables' ]<BR>
			<INPUT TYPE=\"TEXT\" NAME=\"post_sql_database_server_database_name_table_prefix\"><BR>
		...
		* <I>Secure Uniform Resource Locator With Path-To-Cerberus Directory</I>:<BR>
		[ SWU, Secure Sockets Layer ( S.S.L. ), Transport Layer Security ( T.L.S. ), etcetera. Example: https://TinkeSoftware.com/Cerberus ]<BR>
...
/*
 ...
 + Name Create Option, Execute These Installation Details
 ================================================================
*/
...
mysql_query("CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_applications (
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_applications_custom (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_application_links (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_application_panels (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_articles (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_banned_networks (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_comments (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_file_categories (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_files (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_forum_forum (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_forum_post (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_forum_topic (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_links (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_members (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
member_access_level CHAR(1),
member_birthdate VARCHAR(10),
member_bitcoin_address VARCHAR(500),
member_bitcoin_address_bitcoin VARCHAR(500),
member_bitcoin_address_bitcoin_gold VARCHAR(500),
member_bitcoin_address_dogecoin VARCHAR(500),
member_bitcoin_address_ethereum VARCHAR(500),
member_bitcoin_address_litecoin VARCHAR(500),
member_bitcoin_address_mazacoin VARCHAR(500),
member_bitcoin_address_namecoin VARCHAR(500),
member_bitcoin_address_peercoin VARCHAR(500),
member_bitcoin_address_primecoin VARCHAR(500),
member_bitcoin_address_tron VARCHAR(500),
member_bitcoin_address_zcash VARCHAR(500),
member_electronic_mail_address VARCHAR(250),
...
member_name_last VARCHAR(50),
member_name_middle VARCHAR(50),
member_name_nickname VARCHAR(50),
member_number_of_posts CHAR(10),
member_password VARCHAR(250),
member_profile_about TEXT,
member_rank_level CHAR(1),
member_registration_date VARCHAR(50),
member_registration_details TEXT,
member_security_pgp_key_panel_public TEXT,
member_settings_language VARCHAR(20),
member_settings_signature VARCHAR(500),
...
member_status_account_activation_key VARCHAR(40),
member_status_active VARCHAR(14),
member_status_banned CHAR(1),
member_status_newsletter CHAR(1),
member_status_sound CHAR(1),
member_theme_directory VARCHAR(50),
member_url_homepage VARCHAR(250),
member_username VARCHAR(50),
PRIMARY KEY (id)
");

/* Messenger Plain-Text-File Chat Room */

mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_messenger_plain_text_file_chat_room (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
/* Messenger Plain-Text Chat Room Messages */

mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_messenger_plain_text_chat_room_messages (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
chat_room_name VARCHAR(100),
...
/* Messenger Encrypted-Text-File Chat Room */

mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_messenger_encrypted_text_file_chat_room (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_news (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_news_submissions (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_private_messages (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_ranks (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
rank_1 VARCHAR(100),
rank_2 VARCHAR(100),
rank_3 VARCHAR(100),
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_settings (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_shout_messages (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_statistics (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_INSTALL_FORM_POST_DATABASE_SERVER_DATABASE_NAME_TABLE_PREFIX\"_system_message (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
message_author VARCHAR(50),
message_data TEXT,
...
/*
 ================================================================
 + Define New System Database Server Connection Configuration File S.Q.L. Connection and Security Variables
 ================================================================
*/
...
} // [ + ] IF: Connect To Database Server

} else {

	echo ("<FONT COLOR=\"#CD0000\">***</FONT> Cerberus: Error: I was not able to Create the Database Server Database Ma,e.<BR>");

} // [ + ] IF: Create Database Server Database Name
...
} // [ + ] IF: Create Database Server Database Name Is Null

} // [ + ] IF: Connection To Database Server Is Null
...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title)VALUES('Latest_Shouts','1','5','1','<CENTER><B>Latest Shouts</B></CENTER><HR>')");
...
member_access_level,
member_birthdate,
member_bitcoin_address_bitcoin,
member_bitcoin_address_bitcoin_gold,
member_bitcoin_address_dogecoin,
member_bitcoin_address_ethereum,
member_bitcoin_address_litecoin,
member_bitcoin_address_mazacoin,
member_bitcoin_address_namecoin,
member_bitcoin_address_peercoin,
member_bitcoin_address_primecoin,
member_bitcoin_address_tron,
member_bitcoin_address_zcash,
...
'Empty Entry :: BitCoin Gold Address',
'Empty Entry :: DodgeCoin Address',
'Empty Entry :: Ethereum Address',
'Empty Entry :: LiteCoin Address',
'Empty Entry :: MazaCoin Address',
'Empty Entry :: NameCoin Address',
'Empty Entry :: PeerCoin Address',
'Empty Entry :: PrimeCoin Address',
'Empty Entry :: TronCoin Address',
'Empty Entry :: ZCash Address',
...
/*
 ================================================================
 + Install Specified Services Root Administrator Account Details
...
copy("./System/Default/Friend/Friend.cerb","./Member/$_POST_ADMINISTRATOR_USERNAME/Files/Document/Electronic_Mail/$_POST_ADMINISTRATOR_ELECTRONIC_MAIL_ADDRESS");
...
copy("./System/Default/Friend/Friend.cerb","./Member/Cerberus/Files/Document/Electronic_Mail/Cerberus@Localhost");
...
} // [ + ] IF: Remove Directory: Installation Directories and Installation Tools
...
} // [ + ] IF: Delete All Installation Files
...
*&nbsp;Server Date: $_GLOBAL_LOCAL_SERVER_DATE<BR>
*&nbsp;Server Date ( RFC ): $_GLOBAL_LOCAL_SERVER_DATE_RFC<BR>
*&nbsp;Server Time ( Minutes ):$_GLOBAL_LOCAL_SERVER_DATE_MINUTES<BR>
*&nbsp;Server Time ( Seconds ):$_GLOBAL_LOCAL_SERVER_DATE_SECONDS<BR><BR>
...
*&nbsp;Server Gateway Interface: $_GLOBAL_LOCAL_SERVER_GATEWAY_INTERFACE<BR>
*&nbsp;Server Address: $_GLOBAL_LOCAL_SERVER_ADDRESS<BR>
*&nbsp;Server Name: $_GLOBAL_LOCAL_SERVER_NAME<BR>
*&nbsp;Server Software: $_GLOBAL_LOCAL_SERVER_SOFTWARE<BR>
*&nbsp;Server Protocol: $_GLOBAL_LOCAL_SERVER_PROTOCOL<BR>
");
